                ...
                <article class="content dashboard-page">
                    <div class="title-block">
                        <h3 class="title"> รายการอาคาร </h3> <!-- หัวหลัก -->
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-block">
										<div class="row">
											<div class="col-md-12">
											<a href="<?php echo site_url('add_building');?>" class="btn btn-primary">เพิ่มข้อมูล</a>
											<br>
											<br>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-12">
												<form action="<?php echo site_url('manage_building');?>" method="POST">
										...
										foreach ($building as $r) {?>               
													<tr>
														...
														<td><center><a href="<?php echo site_url('edit_building/'.$r->building_id);?>" ><button class="btn btn-warning btn-sm">แก้ไข</button></a>&nbsp;<button onclick="chkConfirm(<?= $r->building_id ?>)" class="btn btn-danger btn-sm">ลบ</button></center></td>
													</tr>
												<?php 
												$i++;
											}
...
<script language="JavaScript">
	function chkConfirm(e)
	{
		if(confirm('ยืนยันการลบข้อมูลนี้')==true)
		{
			...
			window.location = "<?= site_url('delete_building/'); ?>"+e;
