					...
					<div class="row">
				    	<div class="col-md-12">
				    		  <div class="form-group">
    								...
    								<input type="text" class="form-control" name="report_topic" id="report_topic" placeholder="โปรดกรอกรหัสนักศึกษา">
  							  </div>
				    	</div>
				    </div>
					<div class="row">
				    ...
				    <div class="row">
				    	<div class="col-md-12">
				    		  <div class="form-group">
    								...
    								<input type="text" class="form-control" name="reporter_name" id="reporter_name" placeholder="โปรดกรอกชื่อ">
  							  </div>
				    	</div>
				    </div>
				    <div class="row">
				    	<div class="col-md-12">
				    		  <div class="form-group">
    								...
    								<input type="text" class="form-control" name="reporter_surname" id="reporter_surname" placeholder="โปรดกรอกนามสกุล">
  							  </div>
				    	</div>
				    </div>
